...
namespace Kho8k\ThemeF365\Controllers;
...
class ThemeF365Controller
{
    public function index(Request $request)
    {
        ...
        return view('themes::themef365.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        if(is_null($movie_related)) {
            $movie_related = $movie->categories[0]->movies()->inRandomOrder()->limit(get_theme_option('movie_related_limit', 9))->get();
            Cache::put($movie_related_cache_key, $movie_related, setting('site_cache_ttl', 5 * 60));
        }

        return view('themes::themef365.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themef365.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,

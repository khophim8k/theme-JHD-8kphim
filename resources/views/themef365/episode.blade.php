...
@section('content')
    <div class="player_content">
                            ...
                            <div class="col-xs-12 col-sm-10 p-a-0 ">    
                                ...
                                <div class="p-2">
                                    <div class="tags-info"
                                        ...
                                        <div class="categori-tag">
                                            <p> Thể loại: </p>
                                            <span class="tags-item-info">
                        ...
                        <ul class="list-episode" id="list_episodes">
                            @foreach ($data->sortByDesc('name', SORT_NATURAL)->groupBy('name') as $name => $item)
									<li><a href="{{ $item->sortByDesc('type')->first()->getUrl() }}"
											title="{{ $name }}" class="@if ($item->contains($episode)) current @endif">{{$server}}</a></li>
							@endforeach
                        </ul>
                    </div>
                @endforeach
        ...
        <!-- xx -->
        <!-- Chỗ này để gắn comment -->
        <!-- xx -->
        <div class="foot-movie-rcm">
            <div class="block-film " style="margin-top: 20px;">
                <h2 class="caption"><span>Có Thể Bạn Thích</span> </h2>
                <ul id="film_related" class="list-film block_thumb">

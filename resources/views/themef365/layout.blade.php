            ...
            <div class="container ">
                ...
                <div class="container " id="wrapper">
                    ...
                    <div class="right-content">
                        ...
                        <div id="list-tag">
                            <div class="right-box-tag tag-header" style="">Từ khóa nổi bật</div>
                            @include('themes::themef365.inc.top_tag')
                        </div>
                    </div>
                </div>
                <div id="list-search"><div class="right-box-tag search-header">Top tìm kiếm</div>
                    @include('themes::themef365.inc.top_search_ft')</div>
            </div>
        </div>
    </div>
@endsection
